...
execute if entity @s[predicate=!stellarity:items/armor/wearing_full_hallowed_armor,tag=stellarity.holy_protection] run function stellarity:items/armors/hallowed_armor/holy_protection/force_remove

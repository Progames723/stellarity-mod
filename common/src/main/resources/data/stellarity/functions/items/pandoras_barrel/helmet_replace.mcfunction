...
execute if predicate stellarity:items/pandoras_barrel/has_no_helmet run loot replace entity @s armor.head loot stellarity:pandoras_barrel/helmet_generic

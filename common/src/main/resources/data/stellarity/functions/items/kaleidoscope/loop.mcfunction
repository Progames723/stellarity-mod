...
execute if score @s stellarity.items.kaleidoscope.charge matches 33..65 run function stellarity:items/kaleidoscope/holding/particles/1
execute if score @s stellarity.items.kaleidoscope.charge matches 66..98 run function stellarity:items/kaleidoscope/holding/particles/2
execute if score @s stellarity.items.kaleidoscope.charge matches 99..100 run function stellarity:items/kaleidoscope/holding/particles/3

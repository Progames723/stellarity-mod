...
playsound minecraft:entity.elder_guardian.curse player @s[tag=!stellarity.jinxed] ~ ~ ~ 0.4 1.2
playsound minecraft:item.armor.equip_netherite player @s[tag=!stellarity.jinxed] ~ ~ ~ 0.8 0

...
execute if entity @s[tag=stellarity.damage.carcanet] run function kohara:damage/death_messages/starstruck_carcanet

#> Spirit Dagger teleport slash
execute if entity @s[tag=stellarity.damage.spirit_dagger] run function kohara:damage/death_messages/spirit_dagger

#> Dragon punch
execute if entity @s[tag=stellarity.damage.dragonblade] run function kohara:damage/death_messages/dragonblade
...
#> Kaleidoscope
execute if entity @s[tag=stellarity.damage.kaleidoscope] run function kohara:damage/death_messages/kaleidoscope
